...
class ConductorRoutes {
    ...
    config() {
        ...
        this.router.get('/api/conductor', conductorController_1.default.listarConductores);
        this.router.get('/api/conductor/:id', conductorController_1.default.ObtenerConductor);
