...
class FedatarioController {
    listarFedatados(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const personas = yield database_1.default.query('select * from t_fedatar');
    ...
    ObtenerFedatadoEstadoIdExpediente(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                const consulta = `
                            ...
                            where
                                ex.id_expediente=$1
            `;
                const fedatado = yield database_1.default.query(consulta, [id_expediente]);
    ...
    ObtenerExpedienteDetalleXidExpediente(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const { id_expediente } = req.params;
                const consulta = `
                        ...
                        where
                            ex.id_expediente=$1
            `;
                const expediente = yield database_1.default.query(consulta, [id_expediente]);
    ...
    ObtenerResponsablesExpediente(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const { id_expediente } = req.params;
                const consulta = `
...
exports.default = fedatarioController;
