...
@Component({
  selector: 'app-fedatario',
  templateUrl: './fedatario.component.html',
  styleUrls: ['./fedatario.component.css']
})

 
export class FedatarioComponent implements OnInit  {
  inventarios:any=[]
  inventariosTem:any=[]
  ...
  fedatarExpepientes(id_inventario:any){
 
     this.router.navigate(['principal/fedatario/expedientes/',id_inventario])
  }
