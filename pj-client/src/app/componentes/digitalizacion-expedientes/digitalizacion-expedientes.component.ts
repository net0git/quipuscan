...
@Component({
  ...
  styleUrls: ['./digitalizacion-expedientes.component.css']
})
export class DigitalizacionExpedientesComponent implements OnInit{
  ...
  constructor(private activatedRoute:ActivatedRoute,private router:Router,private inventarioService:InventarioService){}
  ...
  DigitalizarExpedientes(id_inventario:any){
    this.router.navigate(['principal/digitalizacion/expedientespreparados/',id_inventario])
  }
}
